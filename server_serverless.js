...
const app = express();
const PORT = 5000; // Port ini hanya efek di local, di Vercel otomatis
...
// --- KONEKSI DB (Singleton Pattern untuk Serverless) ---
...
// Middleware koneksi DB untuk setiap request
...
app.get('/', (req, res) => res.send('Server Toko Online Berjalan!'));
